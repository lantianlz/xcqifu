...
IMG0_DOMAIN = 'http://img0.xcqifu.com'

EMAIL_FROM = u'"小橙企服" <service@3-10.cc>'
EMAIL_HOST_USER = 'service@3-10.cc'
EMAIL_HOST_PASSWORD = ''
EMAIL_HOST = 'smtp.mxhichina.com'
EMAIL_PORT = '25'
NOTIFICATION_EMAIL = ['web@3-10.cc']
NOTIFICATION_VIP_EMAIL = 'vip@3-10.cc'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'www_xcqifu',                      # Or path to database file if using sqlite3.
    ...
    'account': {
        'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'account_xcqifu',                      # Or path to database file if using sqlite3.
        'USER': DB_USER,                      # Not used with sqlite3.
        'PASSWORD': DB_PWD,                  # Not used with sqlite3.
        'HOST': DB_HOST,                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
...
# SESSION_COOKIE_DOMAIN = '.xcqifu.com' if not LOCAL_FLAG else '.a.com'
SESSION_COOKIE_NAME = 'sessionid_xcqifu'
